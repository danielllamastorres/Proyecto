...
public class MicroservicioAdd {


    public static void main(String[] args) {
        MicroservicioAdd server = new MicroservicioAdd(5001);
    }

    public MicroservicioAdd(int port) {
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (operation.equals("+")) {
                        ...
                        System.out.println("No recibo esta operacion: " + input);
                    }
