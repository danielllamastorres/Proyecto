...
public class Whatsapp extends Application{
    private final String password = "21"; // Set your desired password here
    ...
    public void start(Stage primaryStage) {
        uploadButton.setOnAction(e -> {
            ...
            if (selectedFile != null) {
                // File selected, perform necessary operations
        ...
        VBox root = new VBox(20, passwordField, submitButton, uploadButton);
        root.setPadding(new Insets(20));

        submitButton.setOnAction(e -> {
            String enteredPassword = passwordField.getText();
            if (enteredPassword.equals(password)) {
                // Password is correct, perform necessary operations
